...
const CarCard = ({car}) => {
  ...
  return (
    <div onClick={()=> {navigate(`/car-details/${car.id}`); scrollTo(0,0)}} className='group h-full flex flex-col rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'>
      ...
      <div className='flex-1 p-4 sm:p-5 flex flex-col'>
        ...
        <div className='mt-4 grid grid-cols-2 gap-y-2 text-gray-600 min-h-16'>
            ...
            <div className='flex items-center text-sm text-muted-foreground min-w-0'>
                ...
                <span className='whitespace-normal break-words leading-tight'>{car.location}</span>
            </div>
        </div>
