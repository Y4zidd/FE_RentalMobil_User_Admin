...
const translations = {
    en: {
        ...
        profile_subtitle: 'Update your personal  details here.',
        ...
        extras_theft_description: 'Protects you if the rental car is stolen. Requires a police report and does not cover personal belongings left inside the vehicle.',
        extras_collision_label: 'Collision damage waiver',
        extras_collision_description: 'Reduces the amount you pay if the car is damaged in an accident. Does not cover reckless driving, drunk driving, or violations of traffic laws.',
        extras_full_insurance_label: 'Full insurance',
        extras_full_insurance_description: 'Combines theft protection and collision damage waiver with extended coverage, lower customer liability, and priority claim handling.',
        extras_driver_service_label: 'Driver service',
        extras_driver_service_description: 'Includes a professional driver for up to 12 hours per day. Fuel, tolls, parking, and the driver’s meals are paid by the customer. Overtime hours and out-of-city trips may incur additional charges.',
    ...
    id: {
        ...
        toast_session_expired: 'Sesi berakhir, silakan masuk kembali',
        toast_failed_load_cars: 'Gagal memuat data mobil',
        ...
        checkout_toast_payment_popup_closed: 'Jendela pembayaran ditutup. Anda dapat membayar nanti dari halaman Pemesanan Saya.',
        ...
        profile_toast_avatar_not_image: 'Silakan unggah berkas gambar',
        ...
        checkout_title: 'Checkout',
        checkout_subtitle: 'Tinjau detail perjalanan Anda dan selesaikan pemesanan',
        ...
        checkout_license_info: 'Setelah pemesanan, Anda perlu mengirimkan foto SIM untuk verifikasi.',
        ...
        checkout_pay_later_description: 'Bayar penuh saat mengambil kendaraan di lokasi.',
        checkout_payment_method_heading: 'Metode pembayaran',
        checkout_payment_method_gateway: 'Gateway Pembayaran Online',
        checkout_terms_text: 'Saya setuju membayar total biaya dan terhadap',
        ...
        checkout_promo_help: 'Hanya satu kode promo yang dapat digunakan per perjalanan. Jika beberapa kode ditambahkan, hanya yang terakhir yang berlaku.',
        ...
        cars_subtitle_without_search: 'Jelajahi pilihan mobil premium kami untuk perjalanan Anda berikutnya',
        ...
        booking_details_back_to_bookings: 'Kembali ke pemesanan',
        booking_details_heading: 'Detail Pemesanan',
        booking_details_subtitle: 'Tinjau detail pemesanan sewa mobil Anda',
        ...
        booking_details_payment_status_pending: 'Menunggu',
        ...
        booking_details_daily_rate: 'Harga per hari',
        ...
        booking_details_total_amount: 'Total biaya',
        ...
        home_scroll_hint: 'Gulir ke bawah untuk melihat konten lainnya',
        ...
        profile_subtitle: 'Perbarui detail pribadi anda di sini.',
        ...
        extras_theft_description: 'Melindungi Anda jika mobil sewaan hilang karena pencurian. Wajib laporan polisi dan tidak menanggung barang pribadi yang tertinggal di dalam kendaraan.',
        extras_collision_label: 'Perlindungan kerusakan',
        extras_collision_description: 'Mengurangi biaya yang harus Anda bayar jika mobil rusak karena kecelakaan. Tidak berlaku untuk berkendara ugal-ugalan, di bawah pengaruh alkohol, atau pelanggaran lalu lintas.',
        extras_full_insurance_label: 'Asuransi penuh',
        extras_full_insurance_description: 'Menggabungkan perlindungan pencurian dan kerusakan dengan cakupan lebih luas, tanggungan pelanggan lebih kecil, dan proses klaim yang diprioritaskan.',
        extras_driver_service_label: 'Layanan sopir',
        extras_driver_service_description: 'Termasuk sopir profesional hingga 12 jam per hari. Bahan bakar, tol, parkir, dan makan sopir ditanggung penyewa. Lembur dan perjalanan luar kota dapat dikenakan biaya tambahan.',
        ...
        car_details_free_cancellation_suffix: ', pukul 10.00',
