    ...
    <div className='relative h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0'>
      ...
      <div className='flex h-full items-center justify-center p-4 lg:p-8'>
        <div className='flex w-full max-w-md flex-col items-center justify-center space-y-6'>
          ...
          {/* Placeholder sign up form now that Clerk is removed */}
          <div className='w-full space-y-4 rounded-lg border bg-card p-6 shadow-sm'>
            <h2 className='text-xl font-semibold text-center'>Create Account</h2>
            <p className='text-muted-foreground text-sm text-center'>
              Static template only. Wire this up to your Laravel backend later.
            </p>
            ...
            <button className={cn(buttonVariants(), 'w-full')}>Sign Up</button>
          </div>
